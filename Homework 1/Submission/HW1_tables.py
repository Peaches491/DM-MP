...
if __name__ == "__main__":
    ...
    TableFiveTransform = array([[1, 0, 0, -1.8772],
                                [0, 1, 0, -1.2344],
                                [0, 0, 1,  0.7400],
                                [0, 0, 0,  1]])

    TableSixTransform = array([[1, 0, 0, -1.2434],
                               [0, 1, 0, -1.2344],
                               [0, 0, 1,  0.7400],
                               [0, 0, 0,  1]])

    with env:
        print env.GetKinBody('Table5').SetTransform(TableFiveTransform)
        print env.GetKinBody('Table6').SetTransform(TableSixTransform)
        pass
